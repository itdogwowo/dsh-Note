...
description: 'Redis performance optimization and best practices. Use this skill when working with Redis data structures, Redis Query Engine (RQE), vector search with RedisVL, semantic caching with LangCache, or optimizing Redis performance. 中文觸發：Redis 資料結構、向量搜尋、語意快取、效能調校。'
license: MIT
metadata:
  author: redis
  version: "1.0.0"
