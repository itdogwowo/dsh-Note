...
description: 'Use when the user requests a professional research or consulting-grade report: market analysis, consumer insights, brand analysis, financial analysis, industry research, competitive intelligence, or investment due diligence. Two phases: (1) build the analysis framework and data requirements; (2) produce the final report with narratives, charts, and strategic insights. 中文觸發：寫研究報告、市場分析、競品分析、產業研究、盡職調查、顧問級報告。'
---
